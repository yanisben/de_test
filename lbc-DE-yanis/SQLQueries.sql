...
insert into transactions values ('2019/01/02', 1234, 999, 490756, 50, 1);
insert into transactions values ('2019/01/03', 1234, 999, 389728, 3.56, 4);
insert into transactions values ('2019/01/02', 3456, 845, 490756, 50, 2);
insert into transactions values ('2019/01/03', 3456, 845, 549380, 300, 1);
insert into transactions values ('2019/01/02', 3456, 845, 490756, 10, 6);
